<window
    ...
    <holder class="padding-8">
        <span class="headline-medium weight-500 dm-sans left-margin-16">Créditos</span>
        <div class="content-box light-color padding-32 border-radius-16">
            <p class="headline-small outline-text dm-sans text-wrap-pretty">
                Proyecto totalmente desarrollado por <span class="primary-text weight-500">Luis David Elizarraraz Mondaca</span>,
                con la iniciativa original en <span class="primary-text weight-500">Stepbro Software</span> como <span class="primary-text weight-500">Stepbro Mind</span>.   
            </p>
